<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cArticulos.aspx.cs" Inherits="WarehousePharmacySystemWeb.Consultas.cArticulos" %>
        ...
        <div>
            <div class="form-group">
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col-lg-11">
                        <asp:GridView ID="ArticuloGridView" runat="server" AllowPaging="true" PageSize="7" CssClass="table table-striped table-hover table-responsive-lg" OnPageIndexChanging="ArticuloGridView_PageIndexChanging" AutoGenerateColumns="False">
